    ...
    def analyse(self, json_data):
        ...
        for row in json_data:
            ...
            for key, val in row.items():
                if key != 'COMMENT':
                    if str(key) in self.option_data.keys():
                        option_val = self.option_data.get(str(key))
                        option_val.append(val)
                        self.option_data[str(key)] = option_val
                    else:
                        self.option_data[str(key)] = [val]
